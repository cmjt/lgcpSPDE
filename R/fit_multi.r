...
#' @param binary.response list of length three. each refering to presence = 1, absence = 0 of the bird species
...
#' in order thes refer to the parameters beta_z3, gamma_z3, beta_y3, and gamma_y3 (see model definition).
