#include <TMB.hpp>
#include "/home/charlotte/Documents/Gitwork/lgcpSPDE/src/nonstatspde.hpp"
...
Type objective_function<Type>::operator() ()
{
  ...
  using namespace non_stat; // this where the structure for GMRF is defined my own)
  DATA_VECTOR(resp);
  DATA_VECTOR(area);
  ...
  SparseMatrix<Type> Q = Q_spde_nonstat(spde,theta2,theta3); // create the prec matrix from the spde model for the GMRF
